...
| NASA data usage | 1–5 | NASA open data plus another agency or third-party source, clearly shown | NASA: BASS-II, the PSI-25 experimental table (via the PSI API), NTRS, the OCHMO-TB-008 fire-protection brief, the 2015 exploration-atmosphere evidence report, Saffire IV–VI (with ESA ESTEC and partner universities), SoFIE, LUCI. Third party: *Sci. Reports* 2018, *Fire Safety Journal* 2024. Planned: FSCD Bangladesh. | ✅ (show in the drawer) |
